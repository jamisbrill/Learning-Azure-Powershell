...
#Move the resource 
Move-AzResource -DestinationResourceGroupName "NewTestRG" -ResourceId "/subscriptions/Some ID Here /resourceGroups/TestRG/providers/Microsoft.Network/virtualNetworks/TestRG-vnet"  # Put a resource id here 
